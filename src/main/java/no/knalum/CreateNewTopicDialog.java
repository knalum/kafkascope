...
public class CreateNewTopicDialog extends JDialog {
    public CreateNewTopicDialog(Consumer<Params> cb) {
        ...
        createButton.addActionListener(e -> {
            ...
            // TODO: Call Kafka topic creation logic here
            cb.accept(new Params(topicName, partitions, replication, cleanupPolicy, retention));
            dispose();
        });
    }
...
record Params(String topicName, int partitions, int replication, String cleanupPolicy, int retention) {
