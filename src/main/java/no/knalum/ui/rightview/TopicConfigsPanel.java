...
public class TopicConfigsPanel extends JPanel implements MessageListener {
    private final JPanel configPanel;
    private String selectedTopic;

    public TopicConfigsPanel() {
    ...
    public void handleMessage(AppMessage message) {
        if (message instanceof TreeTopicChangedMessage topicSelected) {
